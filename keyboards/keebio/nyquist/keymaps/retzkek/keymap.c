...
[_FN] = LAYOUT( \
  ...
  _______, KC_GRV , KC_HOME, KC_UP,   KC_END,  KC_VOLU, KC_PGUP, KC_7,    KC_8,    KC_9,    KC_MINS, KC_EQUAL, \
  _______, KC_LPRN, KC_LEFT, KC_DOWN, KC_RIGHT,KC_RPRN, KC_PGDN, KC_4,    KC_5,    KC_6,    KC_PLUS, KC_EQUAL, \
  _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, KC_VOLD, _______, KC_1,    KC_2,    KC_3,    KC_ASTR, _______, \
